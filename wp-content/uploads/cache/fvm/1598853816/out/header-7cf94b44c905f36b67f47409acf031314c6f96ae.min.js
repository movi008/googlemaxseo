/* http://PLACEHOLDER.wpsho/wp-content/plugins/revslider/public/assets/js/rbtools.min.js */
try{
/*******************************************************
 ...
 * @see http://github.com/mattbryson/TouchSwipe-Jquery-Plugin
...
/* http://PLACEHOLDER.wpsho/wp-content/plugins/revslider/public/assets/js/rs6.min.js */
try{
/*!
...
GET LICENSE AT: 
http://www.themepunch.com/links/slider_revolution_wordpress_regular_license

LICENSE:
Copyright (c) 2009-2019, ThemePunch. All rights reserved.
This work is subject to the terms at http://www.themepunch.com/links/slider_revolution_wordpress_regular_license (Regular / Extended)
...
/* http://PLACEHOLDER.wpsho/wp-content/plugins/popup-exit/public/assets/js/jquery-cookie/jquery.cookie.js */
try{
/*!
...
return result}
api.get=api.set=api;api.getJSON=function(){return api.apply({json:!0},[].slice.call(arguments))};api.defaults={};api.remove=function(key,options){api(key,'',extend(options,{expires:-1}))};api.withConverter=init;return api}
return init()}));

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* http://PLACEHOLDER.wpsho/wp-content/plugins/popup-exit/public/assets/js/public.js */
try{
jQuery(document).ready(function($){$(".chch-pfc-close").click(function(e){e.preventDefault();chchPopUpID=$(this).attr('data-modalID');controlViews=$(this).attr('data-views-control');controlExpires=$(this).attr('data-expires-control');if(controlViews==='yes'&&controlExpires!='refresh'){if(!Cookies.get('shown_modal_'+chchPopUpID)){switch(controlExpires){case 'session':Cookies.set('shown_modal_'+chchPopUpID,'true',{path:'/'});break}}}
$("#modal-"+chchPopUpID).hide("fast")});$(".cc-pu-buttons a").click(function(e){e.preventDefault();var buttonTarget=$(this).attr('href');$(".chch-pfc-close").trigger('click');window.location.href=buttonTarget})});
