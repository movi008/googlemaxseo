/* http://PLACEHOLDER.wpsho/wp-includes/js/jquery/ui/position.min.js */
try{
/*!
...
/* http://PLACEHOLDER.wpsho/wp-content/plugins/elementor/assets/lib/dialog/dialog.min.js */
try{
/*! dialogs-manager v4.7.6 | (c) Kobi Zaltzberg | http://github.com/kobizz/dialogs-manager/blob/master/LICENSE.txt 
 2020-02-11 15:22 */
...
/* http://PLACEHOLDER.wpsho/wp-content/plugins/elementor/assets/lib/waypoints/waypoints.min.js */
try{
...
/* http://PLACEHOLDER.wpsho/wp-content/plugins/elementor/assets/lib/swiper/swiper.min.js */
try{
/**
 * Swiper 5.3.6
...
/* http://PLACEHOLDER.wpsho/wp-content/plugins/elementor/assets/lib/share-link/share-link.min.js */
try{
(function(a){window.ShareLink=function(b,c){var d,e={},f=function(a){var b=a.substr(0,e.classPrefixLength);return b===e.classPrefix?a.substr(e.classPrefixLength):null},g=function(a){d.on("click",function(){h(a)})},h=function(a){var b="";if(e.width&&e.height){var c=screen.width/2-e.width/2,d=screen.height/2-e.height/2;b="toolbar=0,status=0,width="+e.width+",height="+e.height+",top="+d+",left="+c}var f=ShareLink.getNetworkLink(a,e),g=/^https?:\/\//.test(f),h=g?"":"_self";open(f,h,b)},i=function(){a.each(b.classList,function(){var a=f(this);if(a)return g(a),!1})},j=function(){a.extend(e,ShareLink.defaultSettings,c),["title","text"].forEach(function(a){e[a]=e[a].replace("#","")}),e.classPrefixLength=e.classPrefix.length},k=function(){d=a(b)};(function(){j(),k(),i()})()},ShareLink.networkTemplates={twitter:"http://twitter.com/intent/tweet?text={text}{url}",pinterest:"http://www.pinterest.com/pin/create/button/?url={url}&media={image}",facebook:"http://www.facebook.com/sharer.php?u={url}",vk:"http://vkontakte.ru/share.php?url={url}&title={title}&description={text}&image={image}",linkedin:"http://www.linkedin.com/shareArticle?mini=true&url={url}&title={title}&summary={text}&source={url}",odnoklassniki:"http://connect.ok.ru/offer?url={url}&title={title}&imageUrl={image}",tumblr:"http://tumblr.com/share/link?url={url}",delicious:"http://del.icio.us/save?url={url}&title={title}",google:"http://plus.google.com/share?url={url}",digg:"http://digg.com/submit?url={url}",reddit:"http://reddit.com/submit?url={url}&title={title}",stumbleupon:"http://www.stumbleupon.com/submit?url={url}",pocket:"http://getpocket.com/edit?url={url}",whatsapp:"http://api.whatsapp.com/send?text=*{title}*\n{text}\n{url}",xing:"http://www.xing.com/app/user?op=share&url={url}",print:"javascript:print()",email:"mailto:?subject={title}&body={text}\n{url}",telegram:"http://telegram.me/share/url?url={url}&text={text}",skype:"http://web.skype.com/share?url={url}"},ShareLink.defaultSettings={title:"",text:"",image:"",url:location.href,classPrefix:"s_",width:640,height:480},ShareLink.getNetworkLink=function(a,b){var c=ShareLink.networkTemplates[a].replace(/{([^}]+)}/g,function(a,c){return b[c]||""});if("email"===a){if(-1<b.title.indexOf("&")||-1<b.text.indexOf("&")){var d={text:b.text.replace(/&/g,"%26"),title:b.title.replace(/&/g,"%26"),url:b.url};c=ShareLink.networkTemplates[a].replace(/{([^}]+)}/g,function(a,b){return d[b]})}return c.indexOf("?subject=&body")&&(c=c.replace("subject=&","")),c}return c},a.fn.shareLink=function(b){return this.each(function(){a(this).data("shareLink",new ShareLink(this,b))})}})(jQuery);
